...
Click "Browse" to select your raw data file (CSV or Excel).

Select the desired processing function (e.g., "Process LEfSe", "Modify Filenames", or "Confirm") to execute the automated pipeline.

Option 2: Scripting Mode
Standardizing Microbial Data: Update the input file path in Microbe.py and call the resolve_microbe() function for batch processing.

Validating Consistency: Run __init__.py to output any BioProject discrepancies between metadata and taxonomic abundance tables.
